...
from model_gt import DM2FNetv8
...
args = {
   ...
   # 'snapshot':'iter_10000_loss_0.01737_lr_0.000386'
    ...
    'snapshot':'iter_30000_loss_0.00937_lr_0.000026'
    #'snapshot':'iter_80000_loss_0.00963_lr_0.000000'
}
    ...
    with torch.no_grad():
        ...
        for name, root in to_test.items():
            if 'SOTS' in name:
                ...
                net = DM2FNetv8().cuda()
                dataset = OHazeDataset(root,'train_crop_512')
